...
public class ConsoleDatePrinter implements DataPrinter {

    private final CellNumberConverter cellNumberConverter;

    public ConsoleDatePrinter(final CellNumberConverter cellNumberConverter) {
    ...
    public void printInstructions() {
        printInfoMessage("Use the following mapping table to specify a cell using number from 1 to 9");
